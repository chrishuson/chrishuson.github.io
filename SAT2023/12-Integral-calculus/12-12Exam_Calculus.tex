...
\newpage
  ...
  \begin{enumerate}
    ...
    \item Write down a definite integral that represents the are of the region enclosed by the graph of $f$ and the $x$-axis from $x=0$ to $x=2$. \vspace{1.5cm}
    \item Find the area of the region using the antiderivative and applying the fundamental theorem of calculus.
  \end{enumerate}
